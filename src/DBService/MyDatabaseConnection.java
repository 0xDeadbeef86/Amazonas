...
public class MyDatabaseConnection {
    ...
    public void connect() {
        try {
            ...
            database = DriverManager.getConnection("jdbc:postgresql://localhost:5432/dbprojekt", "projekt", "geheim"); // localhost:5432/dbprojekt", "projekt", "geheim"         "jdbc:postgresql://localhost:5432/postgres", "postgres", "postgres"
